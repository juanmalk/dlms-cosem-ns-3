 ...
 */
#ifndef UDP_COSEM_SERVER_HELPER_H
#define UDP_COSEM_SERVER_HELPER_H
...
class UdpCosemServerHelper
{
public:

  UdpCosemServerHelper ();

  UdpCosemServerHelper (Ipv4InterfaceContainer interface);

  // Record an attribute to be set in each Application after it is is created
  void SetAttribute (std::string name, const AttributeValue &value);

  /** 
   * Create one udp cosem server application on each of the input nodes and 
...
#endif /* UDP_COSEM_SERVER_HELPER_H*/
